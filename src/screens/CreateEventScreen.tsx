...
const styles = StyleSheet.create({
  ...
  headerTitle: {
    fontSize: getTabletSafeDimension(18, 22, 24),
    color: '#252B37',
    fontWeight: '700',
  ...
  labelText: {
    ...
    lineHeight: getTabletSafeDimension(16, 20, 22),
    letterSpacing: 0,
  ...
  timeSlotLabel: {
    fontSize: getTabletSafeDimension(12, 15, 17),
    fontFamily: Fonts.latoMedium,
    lineHeight: getTabletSafeDimension(12, 16, 18),
    letterSpacing: 0,
    color: colors.grey400,
    marginBottom: spacing.xs,
  },
  ...
  customRepeatEveryInput: {
    width: '100%',
    height: getTabletSafeDimension(scaleHeight(40), 54, 54),
    borderWidth: 1,
    borderColor: '#DCE0E5',
    borderRadius: borderRadius.sm,
    textAlign: 'left',
  ...
  customUnitDropdownItem: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: '#F0F0F0',
    minHeight: getTabletSafeDimension(scaleHeight(40), 54, 56),
    justifyContent: 'center',
  },
  ...
  customRepeatUnitText: {
    ...
    marginRight: spacing.xs,
    fontFamily: Fonts.latoRegular,
    lineHeight: getTabletSafeDimension(fontSize.textSize14, 20, 22),
  },
  ...
  timezoneModalCloseText: {
    fontSize: getTabletSafeDimension(fontSize.textSize17, 18, 20),
    color: colors.blackText,
    fontWeight: '400',
  },
  ...
  useCurrentTimezoneButtonText: {
    fontSize: getTabletSafeDimension(14, 17, 19),
    color: '#252B37',
    fontWeight: '400',
    fontFamily: Fonts.latoRegular,
  },
  ...
  integrationModalTitle: {
    fontSize: getTabletSafeDimension(fontSize.textSize18, 19, 21),
    fontWeight: '600',
    color: Colors.black,
    textAlign: 'center',
    fontFamily: Fonts.latoBold,
  ...
  integrationModalDescription: {
    ...
    textAlign: 'center',
    marginBottom: getTabletSafeDimension(spacing.sm, spacing.xs, spacing.sm),
    lineHeight: getTabletSafeDimension(20, 22, 24),
    fontFamily: Fonts.latoRegular,
  },
