...
const styles = StyleSheet.create({
  ...
  headerSection: {
    ...
    paddingTop: getTabletSafeDimension(scaleHeight(20), 16, 24),
    paddingBottom: getTabletSafeDimension(scaleHeight(16), 12, 18),
  },
  headerTitle: {
    fontSize: getTabletSafeDimension(moderateScale(18), 14, 20),
    fontWeight: '700',
    color: '#000',
    fontFamily: Fonts.latoBold,
    flexShrink: 1,
    flexWrap: 'wrap',
    marginRight: getTabletSafeDimension(scaleWidth(12), 8, 14),
  },
  clearBinButton: {
    fontSize: getTabletSafeDimension(moderateScale(16), 12, 18),
    fontWeight: '500',
    color: '#00AEEF',
  ...
  eventCard: {
    backgroundColor: '#fff',
    borderRadius: getTabletSafeDimension(moderateScale(12), 10, 14),
    padding: getTabletSafeDimension(scaleWidth(16), 12, 18),
    borderLeftWidth: 4,
  ...
  eventTitle: {
    fontSize: getTabletSafeDimension(moderateScale(16), 15, 18),
    fontWeight: '600',
    color: '#717680',
  ...
  eventLabels: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: getTabletSafeDimension(scaleWidth(8), 6, 10),
  },
  timeLabel: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: getTabletSafeDimension(scaleWidth(8), 6, 10),
    paddingVertical: getTabletSafeDimension(scaleHeight(4), 3, 6),
    borderRadius: getTabletSafeDimension(moderateScale(16), 14, 18),
    backgroundColor: 'transparent',
    borderWidth: 0.5,
    borderColor: '#D5D7DA',
    gap: getTabletSafeDimension(scaleWidth(4), 3, 6),
  },
  timeLabelText: {
    fontSize: getTabletSafeDimension(moderateScale(12), 12, 14),
    fontWeight: '500',
    color: '#717680',
    fontFamily: Fonts.latoMedium,
    textDecorationLine: 'line-through',
  ...
  menuButtonContainer: {
    marginLeft: getTabletSafeDimension(scaleWidth(8), 6, 10),
  },
  menuButton: {
    padding: getTabletSafeDimension(scaleWidth(4), 3, 6),
  },
  menuPopup: {
    backgroundColor: '#fff',
    borderRadius: getTabletSafeDimension(moderateScale(8), 6, 10),
    paddingVertical: getTabletSafeDimension(scaleHeight(4), 3, 6),
    minWidth: getTabletSafeDimension(scaleWidth(120), 100, 140),
    ...shadows.md,
  },
  strikethroughIcon: {
    opacity: 0.6,
  ...
  menuItem: {
    paddingHorizontal: getTabletSafeDimension(scaleWidth(16), 12, 18),
  ...
  emptyStateDescription: {
    ...
    color: '#717680',
    textAlign: 'center',
    lineHeight: getTabletSafeDimension(20, 16, 22),
  },
  modalOverlay: {
    flex: 1,
  ...
  modalContainer: {
    ...
    borderRadius: getTabletSafeDimension(moderateScale(16), 12, 18),
    padding: getTabletSafeDimension(scaleWidth(24), 26, 32),
    width: '100%',
    maxWidth: getTabletSafeDimension(scaleWidth(340), 380, 420),
    zIndex: 10001,
    elevation: 10001,
    shadowColor: '#000',
    shadowOffset: {
  ...
  modalTitle: {
    fontSize: getTabletSafeDimension(fontSize.textSize18, 17, 20),
    fontWeight: '700',
    color: '#000',
    fontFamily: Fonts.latoBold,
    marginBottom: getTabletSafeDimension(scaleHeight(16), 12, 18),
    textAlign: 'left',
  },
  modalMessage: {
    fontSize: getTabletSafeDimension(fontSize.textSize14, 13, 16),
    fontWeight: '400',
    color: '#717680',
    fontFamily: Fonts.latoRegular,
    marginBottom: getTabletSafeDimension(scaleHeight(24), 18, 28),
    lineHeight: getTabletSafeDimension(scaleHeight(20), 16, 22),
    textAlign: 'left',
  },
  modalButtons: {
    flexDirection: 'row',
    justifyContent: 'flex-end',
    gap: getTabletSafeDimension(scaleWidth(12), 10, 14),
  },
  modalCancelButton: {
    paddingVertical: getTabletSafeDimension(scaleHeight(12), 14, 16),
    paddingHorizontal: getTabletSafeDimension(scaleWidth(24), 26, 32),
    borderRadius: getTabletSafeDimension(moderateScale(8), 6, 10),
    backgroundColor: 'transparent',
  },
  modalCancelText: {
